...
`maxentcpp` is an R package that provides a native C++17
...
associated methodological papers have been cited tens of thousands of
times across ecology, conservation biology, and biogeography
[@Elith2011].
...
integration with modern workflows, and retain scientific comparability
...
`maxentcpp` contributes to this modernization pattern by targeting a
...
reproducing final predictions. To our knowledge, `maxentcpp` is the
first R package to target the Java Maxent 3.4.4 `density.Sequential`
