...
\bottomrule\noalign{}
\endlastfoot
\texttt{maxentcpp} (Sequential, default) & \textasciitilde5.0 ms \\
\texttt{maxnet} & \textasciitilde246 ms \\
\end{longtable}
}

\texttt{maxentcpp} converges in 121 iterations on this fixture. The
end-to-end \texttt{maxent\_run()} workflow adds \textasciitilde1--3 ms
...
49 times faster than \texttt{maxnet} on this benchmark while preserving
